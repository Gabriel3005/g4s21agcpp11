...
public class G4S21AGCPP11 {
    ...
    public static void main(String[] args) {
        // TODO code application logic here
          Datos datos = new Datos("Alejandro",19, "personal@personal.com");
        Gson gson = new Gson();
       ...
       System.out.println("la cadena contiene -> " + cadena);
             String cjson = "{\"nombre\":\"Ale\",\"edad\":19,\"correo\":\"sin correo\"}";
